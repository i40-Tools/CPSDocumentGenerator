...
import edu.bonn.AMLGolStandardGenerator.aml.InternalElementType;

/**
 * @author omar
 *
 */
public class InternalElementNested extends GenericElement {
	...
	public static ArrayList<InternalElementType> setObject() {
		...
		for (int i = 0; i < minimum; i++) {
			internal.add(factory.createInternalElementType());
